...
class MainReportTest {
    ...
    void setUp() {
        customers = new HashSet<Customer>() {{
            add(Customer.builder().name("customer1").age(16).accounts(new HashSet<Account>() {{
                add(Account.builder().number("A1").createDate(LocalDate.of(2021, 7, 15)).balance(new BigDecimal("100000")).build());
            }}).build());
